...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Muli:wght@200;300;400;600&family=Lato:wght@300;400;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
      },
      { rel: "stylesheet", href: "/ps/legacy.css" },
      { rel: "stylesheet", href: "/ps/desktop.css" },
      {
        rel: "stylesheet",
        href: "/ps/mobile.css",
