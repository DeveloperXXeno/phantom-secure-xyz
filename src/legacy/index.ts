...
<div class="tile skrollr-body" id=tile1 data-height-factor="1.1">
	...
	<div class="skrollable" style="position: absolute; top: 0px; width: 55%; right: 0%;" data-0="transform: translate(25%, 0%);" data-1000="transform: translate(-15%, 0%);">
		<img src="/ps/main_3.png" style='width: 50%'><br><br>
	</div>
	<div class="skrollable" style="position: absolute; bottom: 8%; width: 55%; right: 4%;">
...
<div class="tile" data-sb="fadeInUp" data-sb-hide="fadeOutUp">
	...
	<div style="position: absolute; right: 5%; top: 73%; width: 10%">
		<a href="/opportunities"><img src="/ps/main_9.png" width=100%></a>
	</div>
<div class=center>
