...
<div class="tile" data-nomargin=1>
<img src="/ps/legal_bg2.png" class=tileimg style='opacity:0' id=bg1>
<div style="position: absolute; align:center; width:100%; top: 3%;">
	<div class="titlelb" align=center style='color:#534741; font-size: 3.5vw'>LEGAL COMPLIANCE</span>
</span></div>
<center>
	<div class="textlb" style='width:80%; text-align: justify;'>
...
<center><div style='position: relative; width: 80%; margin-top: 2%; height: 46vw; margin-bottom: 8%'>
<table border=0 cellspacing=0 cellpadding=0 width=100%>
<tr><td width=15%><a href='javascript:' onClick='$("#l1").fadeOut();$("#l2").fadeIn();'><img src="/ps/l1.png" style='height:2.5vw'></a></td>
	<td></td>
	<td width=25% align=right><a href='javascript:' onClick='$("#l2").fadeOut();$("#l1").fadeIn();'><img src="/ps/l2.png" style='height:2.5vw'></a></td></tr>
</table>
<div style='background-image: url("/ps/legal_bg.png"); background-repeat: no-repeat; background-color: #262626; position: absolute; background-size: 100%; height: 100%; width: 90%; text-align: left; padding: 5%' class=text>

<div id=l1 style='position: absolute; width: 90%; height: 100%; display: none'>
	<span style='color:6dcff6;  text-transform: uppercase;font-size: 3vw'>Privacy and Practices</span>
	<br><br>
...
<div id=l2 style='position: absolute;  width: 90%; height: 100%;'>
