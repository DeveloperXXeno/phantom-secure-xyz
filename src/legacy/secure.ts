...
<img src="/ps/secure_6.png" class=tileimg style='opacity:0' id=bg1>
<div style="position: absolute; align:center; width:100%; top: 3%;">
	<div class="titlelb" align=center style='color:#534741; font-size: 3.5vw'>Having Secure Communications in Business is Vital.
<br>We make it easy and simple while highly secure<span style='color:#6dcff6'>.</span>
</span></div>
<center>
...
<p>
<span style='color: #534741; font-size: 3.5vw;  text-shadow: 0px 3px 4px rgba(255, 255, 255, 0.6);'>Protect You and Your Business Today.</span>


	
</div></center>
	</div>
<div style='width:100%; height: 30vw; position: absolute; cursor: pointer; bottom: 0vw;' onClick='location="buy.php"; '></div>
</div>
